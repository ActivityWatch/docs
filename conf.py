...
latex_documents = [
    (master_doc, 'ActivityWatch.tex', 'ActivityWatch Documentation',
     'Erik Bjäreholt and contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'activitywatch', 'ActivityWatch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ActivityWatch', 'ActivityWatch Documentation',
     author, 'ActivityWatch', 'One line description of project.',
     'Miscellaneous'),
]
