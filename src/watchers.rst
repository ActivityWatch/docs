...
Other watchers which are very useful too.
 ...
 - :gh:`akohlbecker/aw-watcher-tmux` - A plugin for [tmux](https://github.com/tmux/tmux/wiki) that allows monitoring activity in sessions and panes, by :gh-user:`akohlbecker`
